...
function CreateTaskButton({projectKey, loginId}) {
    ...
    return (
        <div className='addTask'>
            {showModal && <TaskModal onClose={handleToggleModal} onSubmit={handleTaskSubmit} projectKey={projectKey} loginId = {loginId}/>}
