...
function TimelineBoard({ moveToTimelineTitle }) {
  const projectKey = 'P1';
  ...
  const scrollToTitle = (title) => {
    ...
    if (index !== -1) {
      ...
      if (targetRow) {
        ...
        // Adjust to ensure the title is centered in the timeline view
        ...
        setTimeout(() => setHighlightedTitle(null), 2000); // Highlight for 2 seconds
      }
    }
  };
